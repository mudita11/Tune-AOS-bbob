...
class AOS(object):
    ...
    def OM_Update(self):
        ...
        self.reward = self.reward_type.calc_reward() #print("call to quality")
        self.quality = self.quality_type.calc_quality(self.old_reward, self.reward) #print("call to probability")
...
def build_quality(choice, n_ops, prob_args):
    if choice == 0:
        ...
        return Quality3(n_ops)
    elif choice == 4:
        return Quality4(n_ops, qual_args["delta"])
    elif choice == 5:
        return Quality5(n_ops, qual_args["c1_quality6"], qual_args["c2_quality6"], qual_args["gamma"])
    else:
        raise ValueError("choice {} unknown".format(choice))
