...
\providecommand{\cocoversion}{\hspace{\textwidth}\scriptsize\sffamily{}\color{Gray}Data produced with COCO v2.3.3}
\providecommand{\numofalgs}{4}
...
\providecommand{\bbobpptablesmanylegend}[1]{%
        ...
        \cocoversion}
\providecommand{\algsfolder}{DE4-T_DE4-E_DE4-B_DE4-D/}
\providecommand{\algorithmA}{DE4-B}
\providecommand{\algorithmB}{DE4-D}
\providecommand{\algorithmC}{DE4-E-fe}
\providecommand{\algorithmD}{DE4-T-fe}
